...
Таким образом, восстановление спектров космических исзучений по данным измерений является трудной задачей, для корректного решения которой необходим комплексный статистический анализ данных измерений и моделирования.
