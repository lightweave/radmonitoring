...
3.  Разработка модуля оптимизации параметров спектрометра динамического изменения
...
1.  Разработаны основы методов моделирования и анализа спектрометров энергичных протонов и электронов

2.  Создан прототип спектрометра для проекта многоярусной спутниковой группировки. Прототип позволяет проверить разрабатываемые методы моделирования и анализа спектрометров.
